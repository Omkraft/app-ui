				...
				<div className="space-y-8 text-center lg:text-left">
					...
					<div className="space-y-3 max-w-3xl">
						<p className="text-muted-foreground">
							...
							tool for managing different aspects of day-to-day life — without
							complexity.
						</p>

						<p className="text-muted-foreground">
							This is a personal demo project under the Omkraft name. It is not
							an official product (yet), but it is built with care, security,
							and real users in mind.
						</p>
					</div>
					...
					<p className="text-sm text-muted-foreground pt-6">
						For the best experience, try Omkraft on a laptop or desktop if
						possible. Mobile support is improving continuously.
					</p>
				</div>
